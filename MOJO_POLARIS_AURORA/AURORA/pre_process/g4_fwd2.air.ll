...
51:                                               ; preds = %68, %50
  %52 = phi float [ 0.000000e+00, %50 ], [ %87, %68 ]
...
68:                                               ; preds = %65
  ...
  %87 = fadd contract float %52, %86
  br label %51

88:                                               ; preds = %62
  %89 = phi float [ %52, %62 ]
  %90 = bitcast ptr addrspace(1) %45 to ptr addrspace(1)
...
!0 = !{ptr @_04b_train_mlp_gpu_matmul_kernel6A6A_c39ada1ad3cc8008, !1, !2}
!1 = !{}
