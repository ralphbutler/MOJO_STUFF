"""g3_bench_torch_xpu.py — vendor-library matmul yardstick for G3 on one PVC tile.
...
Run on a next-eval compute node with the ALCF frameworks module:
    ...
    ZE_FLAT_DEVICE_HIERARCHY=FLAT ZE_AFFINITY_MASK=0 python g3_bench_torch_xpu.py 2048 50
"""
