...
define void @_04b_train_mlp_gpu_bias_relu_ker6A6A_de19dba94af129ad(ptr addrspace(1) noundef nonnull "air-buffer-no-alias" "nocapture" "noundef" "readonly" %0, ptr addrspace(1) noundef nonnull "air-buffer-no-alias" "nocapture" "noundef" "readonly" %1, ptr addrspace(1) noundef nonnull "air-buffer-no-alias" "nocapture" "noundef" "writeonly" %2, ptr addrspace(2) noundef "air-buffer-no-alias" "nocapture" "noundef" %3, ptr addrspace(2) noundef "air-buffer-no-alias" "nocapture" "noundef" %4, <3 x i32> %threadgroup_position_in_grid, <3 x i32> %thread_position_in_threadgroup, <3 x i32> %threads_per_threadgroup, <3 x i32> %threads_per_grid, i32 %thread_index_in_simdgroup) local_unnamed_addr #0 {
  ...
  %38 = bitcast ptr addrspace(1) %15 to ptr addrspace(1)
  %39 = getelementptr inbounds float, ptr addrspace(1) %38, i64 %37
  %40 = bitcast ptr addrspace(1) %39 to ptr addrspace(1)
  %41 = add i32 %27, %36
  %42 = sext i32 %41 to i64
  %43 = bitcast ptr addrspace(1) %16 to ptr addrspace(1)
  %44 = getelementptr inbounds float, ptr addrspace(1) %43, i64 %42
  %45 = bitcast ptr addrspace(1) %44 to ptr addrspace(1)
  %46 = bitcast ptr addrspace(1) %14 to ptr addrspace(1)
  %47 = getelementptr inbounds float, ptr addrspace(1) %46, i64 %42
  %48 = bitcast ptr addrspace(1) %47 to ptr addrspace(1)
  %49 = sext i32 %.loaded to i64
  %50 = icmp slt i64 %25, %49
  %51 = icmp slt i64 %35, %17
...
53:                                               ; preds = %5
  ...
  %56 = bitcast ptr addrspace(1) %40 to ptr addrspace(1)
  %57 = load float, ptr addrspace(1) %56, align 4
  %58 = fadd contract float %55, %57
  %59 = bitcast ptr addrspace(1) %48 to ptr addrspace(1)
...
!0 = !{ptr @_04b_train_mlp_gpu_bias_relu_ker6A6A_de19dba94af129ad, !1, !2}
!1 = !{}
