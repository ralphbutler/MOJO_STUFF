...
31:                                               ; preds = %48, %30
  %32 = phi float [ 0.000000e+00, %30 ], [ %60, %48 ]
...
48:                                               ; preds = %45
  ...
  %55 = bitcast ptr addrspace(1) %11 to ptr addrspace(1)
  %56 = getelementptr inbounds float, ptr addrspace(1) %55, i64 %54
  ...
  %60 = fadd contract float %32, %59
  br label %31

61:                                               ; preds = %42
  %62 = phi float [ %32, %42 ]
  %63 = bitcast ptr addrspace(1) %27 to ptr addrspace(1)
  store float %62, ptr addrspace(1) %63, align 4
  br label %65
...
!0 = !{ptr @_04b_train_mlp_gpu_colsum_kernel6A6A_eae5be74d2864e3a, !1, !2}
!1 = !{}
