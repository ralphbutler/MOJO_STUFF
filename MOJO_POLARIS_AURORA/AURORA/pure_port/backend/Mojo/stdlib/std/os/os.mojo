...
from std.sys import CompilationTarget, is_gpu, is_apple_gpu, is_intel_gpu
...
def _abort_report[
    *, prefix: StaticString
    ...
    comptime if is_apple_gpu() or is_intel_gpu():
        # FIXME: Remove after MOCO-3697 is fixed.
        # AURORA PATCH (G5): no Intel GPU kernel print path yet.
        pass
    elif is_gpu():
...
def _abort_impl[
    ...
    *,
    ...
    # folds to nothing.
    comptime if not (is_apple_gpu() or is_intel_gpu()):
